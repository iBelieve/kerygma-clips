                ...
                <div class="w-full">
                    <template x-for="(row, i) in rows" :key="i">
                        ...
                        >
                            ...
                            >
                                <div
                                    class="shrink-0 whitespace-nowrap py-1 pe-3 ps-4 text-end text-xs tabular-nums text-gray-500 sm:ps-6 dark:text-gray-400"
                                >
                                ...
                                <div
                                    x-show="diarize"
                                    class="shrink-0 whitespace-nowrap py-1 pe-3"
                                >
                                    <button
                                ...
                                <div
                                    class="min-w-0 flex-1 py-1 pe-4 text-sm text-gray-950 sm:pe-6 dark:text-white"
                                >
